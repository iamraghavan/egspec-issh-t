            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown">
                        ...
                        <li>
                            <a class="dropdown-item" href="<?php echo e(route('user.dashboard', ['google_uid' => Auth::user()->google_id])); ?>">
                                Dashboard
                            </a>
                        </li>
                ...
                <?php else: ?>
                <li class="nav-item">
                    <a class="login-with-google-btn" href="<?php echo e(route('google.login')); ?>">
...
<?php /**PATH D:\laragon\laragon\www\plevents\resources\views/components/header.blade.php ENDPATH**/ ?>