                    ...
                    <li class="nav-item nav-profile dropdown">
                      <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="nav-profile-img">
                          <img src="https://placehold.co/300x300" alt="<?php echo e($user->name); ?> Profile">
              ...
              <div class="container-fluid page-body-wrapper">
                ...
                <nav class="sidebar sidebar-offcanvas" id="sidebar">
                  <ul class="nav">
                    <li class="nav-item nav-profile">
                      <a href="#" class="nav-link">
                        ...
                        <div class="nav-profile-text d-flex flex-column">
                          ...
                          <span class="text-secondary text-small"><?php echo e(config('app.name')); ?> user</span>
                        </div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('admin.dashboard', ['token' => $token])); ?>">
                      ...
                      <li class="nav-item">
                        ...
                        <div class="collapse show" id="sessions-menu">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('sessions.index', ['token' => $token])); ?>">
                                        All Sessions
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('sessions.create', ['token' => $token])); ?>">
                                        Create New Session
                                    </a>
                                </li>
                        ...
                        <div class="collapse show" id="sessions-menu">
                            <ul class="nav flex-column sub-menu">
                                <!-- Link to the index page -->
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('speaker.index', ['token' => $token])); ?>">
                                    Speaker Profile
                                    </a>
                                </li>
                                ...
                                <!-- Link to create a new session -->
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('speaker.create', ['token' => $token])); ?>">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="#">
                          <span class="menu-title">Laravel v<?php echo e(Illuminate\Foundation\Application::VERSION); ?></span>
                    ...
                    <footer class="footer">
                        <div class="container-fluid clearfix">
                            ...
                            <span class="text-muted float-none float-sm-right d-block mt-1 mt-sm-0 text-center">
                                Copyright © 2006 - <?php echo e(date('Y')); ?> All Rights Reserved by EGS Pillay Group of Institutions
                            </span>
...
<script src="https://cdn.datatables.net/1.13.5/js/jquery.dataTables.min.js"></script>
        ...
        <script>
            ...
            function handleAccessDeniedError() {
                if (<?php echo e($errors->has('restricted_area') ? 'true' : 'false'); ?>) {
                    Swal.fire({
                        icon: 'error',
                        title: 'Access Denied',
                        text: '<?php echo e($errors->first('restricted_area')); ?>',
                    });
                }
            }
...
<?php /**PATH D:\laragon\laragon\www\plevents\resources\views/admin/layouts/admin.blade.php ENDPATH**/ ?>