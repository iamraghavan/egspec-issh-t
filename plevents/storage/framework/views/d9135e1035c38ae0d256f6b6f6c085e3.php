...
<form class="form-sample" method="POST" action="<?php echo e(route('speaker.store', ['token' => $token])); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="social_media_handles[]" placeholder="Handle 1">
                    <input type="text" class="form-control" name="social_media_handles[]" placeholder="Handle 2">
                    <input type="text" class="form-control" name="social_media_handles[]" placeholder="Handle 3">
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\plevents\resources\views/admin/pages/speaker/create.blade.php ENDPATH**/ ?>