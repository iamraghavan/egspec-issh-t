<?php if(!Auth::check()): ?>
    ...
    <div id="g_id_onload"
         data-client_id="<?php echo e(env('GOOGLE_CLIENT_ID')); ?>"
         data-callback="handleOneTapLogin"
         data-auto_prompt="true"
         data-auto_select="false"
         data-context="use"
         data-login_uri="<?php echo e(route('google.one-tap-callback')); ?>"
    ...
    <script>
        ...
        function initializeFedCM() {
            FedCM.initialize({
                autoPrompt: true,
                context: 'use',
                loginUri: '<?php echo e(route('google.one-tap-callback')); ?>'
            }).catch(error => {
        ...
        function initializeGoogleOneTap() {
            google.accounts.id.initialize({
                client_id: "<?php echo e(env('GOOGLE_CLIENT_ID')); ?>",
        ...
        function submitToken(token) {
            fetch('<?php echo e(route('google.one-tap-callback')); ?>', {
                method: 'POST',
                headers: {
...
<?php endif; ?>
<?php /**PATH D:\laragon\laragon\www\plevents\resources\views/components/google-sign-in.blade.php ENDPATH**/ ?>